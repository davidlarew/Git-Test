...
const perimeter =  getPerimeter(3,5);
...
const grams = getGramsFromOunces(4);
...
function getPi(value){
    return (value * 3.141541);
}
const pi = getPi(4);

document.querySelector('#challenge-bonus').textContent = pi;